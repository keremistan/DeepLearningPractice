...
class BigEarthDataSet(Dataset):
    ...
    def __getitem__(self, idx):
        ms_images_dirs = self._get_ms_image_dirs()
        ms_image_dir_path = join(self.ms_images_path, ms_images_dirs[idx])
        ...
        if self.transform:
            cur_img_as_arrays = self.transform(cur_img_as_arrays)
...
be_dataset = BigEarthDataSet(ms_images_path)
